...
<aside id="sidebar" class="bg-side-nav  border-r border-side-nav hidden md:block lg:block min-h-screen ">
                <div class="flex">
                    <?php $base_url = "http://localhost/_bluelackesadigital.com/public_html/"; ?>
                </div>
                <ul class="list-reset flex flex-col">
                    ...
                    <li class="w-full h-full py-3 px-2 border-b border-light-border">
                        <a href="<?php echo $base_url; ?>/Auth/SF/Laboratory_Equipments"
                           class="font-sans font-hairline hover:font-normal text-sm text-nav-item no-underline">
                    	...
                    	<li class="w-full h-full py-3 px-2 border-b border-light-border">
                        <a href="<?php echo $base_url; ?>/Auth/SF/Level_Classes"
                           class="font-sans font-hairline hover:font-normal text-sm text-nav-item no-underline">
					...
					<li class="w-full h-full py-3 px-2 border-b border-light-border">
                        <a href="<?php echo $base_url; ?>/Auth/SF/School_class_rooms"
                           class="font-sans font-hairline hover:font-normal text-sm text-nav-item no-underline">
                            <i class="fa fa-home float-left"></i>
                            &nbsp;&nbsp; School Classes
                            <span><i class="fa fa-angle-right float-right"></i></span>
                    ...
                    <li class="w-full h-full py-3 px-2 border-b border-light-border">
                        <a href="<?php echo $base_url; ?>/Auth/SF/Students_perschool"
                           class="font-sans font-hairline hover:font-normal text-sm text-nav-item no-underline">
...
?>
                     ...
                     <li class="w-full h-full py-3 px-2 border-b border-light-border">
                        <a href="<?php echo $base_url; ?>/Auth/SF/Current_Courses"
                           class="font-sans font-hairline hover:font-normal text-sm text-nav-item no-underline">
					...
					<li class="w-full h-full py-3 px-2 border-b border-light-border">
                        <a href="<?php echo $base_url; ?>/Auth/SF/Roles_per_User"
                           class="font-sans font-hairline hover:font-normal text-sm text-nav-item no-underline">
                    	...
                    	<li class="w-full h-full py-3 px-2 border-b border-light-border">
                        <a href="<?php echo $base_url; ?>/Auth/SF/Users_School_allocations"
                           class="font-sans font-hairline hover:font-normal text-sm text-nav-item no-underline">
					...
					<li class="w-full h-full py-3 px-2 border-b border-light-border">
                        <a href="<?php echo $base_url; ?>/Auth/SF/User_profile"
                           class="font-sans font-hairline hover:font-normal text-sm text-nav-item no-underline">
					...
					<li class="w-full h-full py-3 px-2 border-b border-light-border">
                        <a href="<?php echo $base_url; ?>/Auth/SF/Logout"
                           class="font-sans font-hairline hover:font-normal text-sm text-nav-item no-underline">
