...
if (isset($_POST['register'])) {
    ...
    $school_ref = isset($_POST['school_ref']) ? intval($_POST['school_ref']) : 0;
    $user_country = isset($_POST['user_country']) ? intval($_POST['user_country']) : 0;
    $user_region = isset($_POST['user_region']) ? intval($_POST['user_region']) : 3;
    $user_group_ref = 1;

    // Check for duplicate email
    $check_email = "SELECT * FROM users WHERE email_address = '$email'";
    ...
    $check_phone = "SELECT * FROM users WHERE phone_number = '$phone'";
...
<?php endif; ?>
      ...
      <div class="form-section active" id="step1">
        ...
        <div class="mb-4">
          ...
          <select name="user_country" id="COUNTRY" required class="form-select">
        ...
        <div class="mb-4">
          ...
          <select name="school_ref" id="SCHOOL" required class="form-select">
        ...
        <div class="row">
          <div class="col-md-6 mb-3">
            ...
            <select name="access_level" id="access_level" required class="form-select">
              <?php
              $select_permission = mysqli_query($conn, "SELECT * FROM user_permission WHERE per_default='Default'");
  ...
  alert('Selected region ID:', regionId); // Debugging log
  ...
  if (regionId) {
    ...
    function updateFormDisplay() {
      ...
      // ✅ Update confirmation data on final step
      if (currentStep === 3) {
        ...
        // ✅ Update confirmation image
        if (imagePreview && confirmImage && imagePreview.src) {
          confirmImage.src = imagePreview.src;
        }
      }
    }
