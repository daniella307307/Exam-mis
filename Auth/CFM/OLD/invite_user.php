...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        ?><div class="bg-red-300 mb-2 border border-red-300 text-red-dark px-4 py-3 rounded relative" role="alert">
                                    ...
                                    <span class="block sm:inline">This Pnone Number(<?php echo $phone_number;?>) Has been Registred before.</span>
        ...
        window.location.href = "Users_registration";
			...
			$insert =mysqli_query($conn,"INSERT INTO users (phone_number) VALUES 
                  ('$phone_number')");
			if($insert){
