...
$find_region= mysqli_fetch_array(mysqli_query($conn,"SELECT * FROM countries WHERE  id='$Country_Location'"));
$school_region = $find_region['Country_region'];
 $count = mysqli_num_rows(mysqli_query($conn,"SELECT * FROM schools WHERE school_id!='$ID' school_name='$school_name')")); 
...
school_region ='$school_region', school_status = '$school_status' WHERE  school_id =$ID");
 if($update){
