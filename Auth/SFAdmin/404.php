  ...
  <div class="w-full max-w-lg">
    <div class="leading-loose">
      <div class="max-w-xl m-4 p-10 bg-white rounded shadow-xl">
        ...
        <a href="index"><button class="px-4 py-1 text-white font-light tracking-wider bg-gray-900 rounded ml-24" type="submit">Take Me Back To Home</button></a> 
      </div>
