...
$CLASS = $_GET['CLASS'];
$find_class = mysqli_query($conn,"SELECT * FROM school_classes
LEFT join school_levels ON school_classes.class_level = school_levels.level_id

WHERE class_school='$school_ref' AND class_id='$CLASS'");
$class_details = mysqli_fetch_array($find_class);
...
// Count total records
$count_query = "SELECT COUNT(*) FROM student_list WHERE student_class='$CLASS' AND student_school ='$school_ref' AND $action $search_query";
$count_result = mysqli_query($conn, $count_query);
$total_records = mysqli_fetch_array($count_result)[0];

// Fetch records with limit and offset
$select_user = mysqli_query($conn, "SELECT * FROM student_list 
                                   WHERE student_class='$CLASS' AND  student_school ='$school_ref' AND $action $search_query 
        ...
        <div class="flex flex-col">
            ...
            <div class="flex flex-1 flex-col md:flex-row lg:flex-row mx-2">
                <div class="mb-2 border-solid border-gray-300 rounded border shadow-sm w-full">
                    ...
                    <div class="p-3">
                        <center><h1><big>List of students in :</big> <strong><big><?php echo $class_details['class_name'];?></strong></big></h1></center>
                        <br>
