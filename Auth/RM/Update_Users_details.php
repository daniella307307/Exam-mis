...
$regions = mysqli_fetch_array(mysqli_query($conn,"SELECT * FROM countries WHERE id='$user_country'"));
$user_region= $regions['Country_region'];
if(!empty($password)){
...
user_region ='$user_region',
 ...
 if($update){
	header('location:Users?COUNTRY='.$COUNTRY.'&STATUS='.$STATUS.''); 
