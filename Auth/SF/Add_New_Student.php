...
?><div class="bg-red-500 mb-2 border border-red-300 text-white px-4 py-3 rounded relative" role="alert">
	...
	$insert= mysqli_query($conn,"INSERT INTO student_list(student_id,student_first_name, student_last_name, student_dob, student_gender, student_class, student_level, student_school,student_status, student_profile, student_regno) VALUES 
	                                                    (NULL,'$student_first_name','$student_last_name','$student_dob','$student_gender','$student_class','$student_level','$student_school','$student_status','$student_profile','$student_regno')");
if($insert){
