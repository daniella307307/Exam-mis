...
<style>
    ...
    #pdf-container {
        ...
        height: 80vh;
        position: relative;
        overflow: auto; /* only one scrollbar */
        user-select: none;
              ...
              <div class="p-3">
                  ...
                  <div id="pdf-container">
                      <?php if (!empty($externalFile)): ?>
                          ...
                          <div class="watermark">CONFIDENTIAL DOCUMENT • <?php echo htmlspecialchars($course_name); ?></div>
...
document.getElementById("pdf-iframe").addEventListener("load", () => {
    try {
        let innerDoc = document.getElementById("pdf-iframe").contentWindow.document;
        innerDoc.addEventListener("contextmenu", e => e.preventDefault());
        innerDoc.addEventListener("copy", e => e.preventDefault());
