                    ...
                    <div class="flex flex-wrap -mx-3 mb-2">
                        ...
                        <div class="w-full md:w-1/3 px-3 mb-6 md:mb-0">
                            ...
                            <div class="relative">
								...
								<?php 
									$select_school = mysqli_query($conn, "SELECT * FROM allocation_schools
LEFT join schools ON allocation_schools.allocation_school = schools.school_id WHERE   allocation_teacher='$session_id'");
									while($find_school = mysqli_fetch_array($select_school)){
	 ?> <option value="<?php echo $find_school['allocation_school']; ?>"><?php echo $find_school['school_name']; ?></option><?php
									}
