                                    ...
                                    <thead>
                                      <tr>
                                        ...
                                        <th class="border w-1/5 px-4 py-2">Video</th> 
                                         <th class="border w-1/6 px-4 py-2">Visibility</th> 
                                      </tr>
                                    </thead>
                                    <tbody>
									<?php
									...
									?><tr>   
									 <td class="border px-4 py-1"><?php echo $module_details['topic_id'];?></td>
                                           ...
                                           <td class="border px-4 py-2"><?php echo $module_details['topic_title'];?> </td>
                                            ...
                                            <td class="border px-4 py-2">
                                             <a href="Open_course_details?COURSE=<?php echo $COURSE;?>&CERTIFICATE=<?php echo $CERTIFICATE;?>&CURRENT=<?php echo $STATUS;?>&STATUS=Active&ID=<?php echo $module_details['topic_id'];?>" class="bg-green-500 cursor-pointer rounded p-1 mx-1 text-white">
                                                       <i class="fas fa-eay-open text-green-500 mx-2"></i> Open course</a>
                                            </td>
                                             <td class="border px-4 py-2">
                                                 <?php
                                               ...
                                               <td class="border px-4 py-2">
                                                 ...
                                                 if( $topic_visibility=="Visible"){
                                                  ?><a href="Update_visibility?COURSE=<?php echo $COURSE;?>&CERTIFICATE=<?php echo $CERTIFICATE;?>&CURRENT=<?php echo $STATUS;?>&STATUS=Active&ID=<?php echo $module_details['topic_id'];?>" class="bg-green-500 cursor-pointer rounded p-1 mx-1 text-white">
                                                       <i class="fas fa-eay-open text-green-500 mx-2"></i>Visible</a><?php   
                                                 }
                                                 else{
                                                ?><a href="Update_visibility?COURSE=<?php echo $COURSE;?>&CERTIFICATE=<?php echo $CERTIFICATE;?>&CURRENT=<?php echo $STATUS;?>&STATUS=Active&ID=<?php echo $module_details['topic_id'];?>" class="bg-red-500 cursor-pointer rounded p-1 mx-1 text-white">
                                                       <i class="fas fa-eay-open text-green-500 mx-2"></i>Hidden</a><?php     
                                                 }
