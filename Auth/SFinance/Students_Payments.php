                ...
                <div class="mb-2 border-solid border-gray-300 rounded border shadow-sm w-full">
                    <div class="bg-gray-200 px-2 py-3 border-solid border-gray-200 border-b">
                        ...
                        <div class="inline-block ml-2">
                            <input type="hidden" id="statusValue" value="<?php echo $STATUS; ?>">
                            <div class="flex">
                                <input type="text" id="liveSearch" placeholder="Search by name or reg no" 
...
$(document).ready(function() {
    ...
    $('#searchButton').click(function() {
        ...
        var status = $('#statusValue').val();
        window.location.href = 'Students_Payments?STATUS=' + status + '&search=' + encodeURIComponent(searchTerm);
    });
});
</script>
