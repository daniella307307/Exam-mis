...
<style>
            ...
            <div class="flex flex-1 flex-col md:flex-row lg:flex-row mx-2">
                <div class="mb-2 border-solid border-gray-300 rounded border shadow-sm w-full">
                    ...
                    <div class="p-3">
                        ...
                        <p>Location: &nbsp;<strong><big><?php echo $filePath; ?></big></strong></p>
                        
                        
                        <iframe src="https://bluelakes1988.b-cdn.net/courses/Electricity/WEEK1.pdf" height="200" width="300" title="Iframe Example"></iframe>
                        <?php
                        // Corrected file_exists check
                        if (!empty($filePath)) {
                            $localFilePath = str_replace(
                                'https://bluelackesadigital.com/Auth/',
                                '',
                                str_replace('%20', ' ', $filePath)
                            );

                            if (!file_exists($localFilePath)) {
                                ?>
                                <p><strong style="color: green;">File Available on server!</strong></p>
                                <?php
                            }
                        }
                        ?>
    ...
    <iframe 
        src="https://bluelakes1988.b-cdn.net/courses/Electricity/WEEK1.pdf" 
        class="pdf-frame"
        title="PDF Document Viewer"
    >
        Your browser does not support iframes. 
        <a href="https://bluelakes1988.b-cdn.net/courses/Electricity/WEEK1.pdf" target="_blank">
            Open PDF in new window
        </a>
    </iframe>

    <p style="text-align: center; color: #666;">
        If the PDF doesn't load, you may need permission to access it.
    </p>
</body>
</html>