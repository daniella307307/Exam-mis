...
// Add necessary sanitization/validation for $_GET['format'] and other user inputs
...
if ($format == 'excel') {
    ...
    require_once('../../vendor/phpoffice/phpspreadsheet/src/PhpSpreadsheet/Writer/Pdf/Tcpdf.php'); // Ensure the correct path to TCPDF
    ...
    mysqli_data_seek($select_user, 0); // Reset pointer to the beginning
    while ($users_details = mysqli_fetch_array($select_user)) {
        $html .= '<tr>
