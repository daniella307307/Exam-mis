...
$select_user = mysqli_query($conn, "SELECT * FROM student_list WHERE student_school ='$school_ref' AND $action LIMIT $offset, $records_per_page");
?>
            ...
            <div class="flex flex-1 flex-col md:flex-row lg:flex-row mx-2">
                <div class="mb-2 border-solid border-gray-300 rounded border shadow-sm w-full">
                    <div class="bg-gray-200 px-2 py-3 border-solid border-gray-200 border-b">
                        Students &nbsp;
                        <a href="Students_in_Promotions?ID=<?php echo $ID;?>&STATUS=Active"><button class='bg-green-500 hover:bg-blue-800 text-white font-bold py-2 px-4 rounded'>Active</button></a>
                        <a href="Students_in_Promotions?ID=<?php echo $ID;?>&STATUS=Inactive"><button class='bg-red-500 hover:bg-yellow-800 text-white font-bold py-2 px-4 rounded'>Inactive</button></a>
                        <a href="Assign_Students_in_promotion?ID=<?php echo $ID;?>&STATUS=<?php echo $STATUS;?>"><button class='bg-blue-800 hover:bg-yellow-800 text-white font-bold py-2 px-4 rounded'><i class="fas fa-plus"></i>&nbsp;&nbsp;Add Students in promotion</button></a>
                    ...
                    <div class="p-3">
                        <table class="table-responsive w-full rounded">
                            <thead>
                                <tr>
                                    <th class="border w-1/8 px-4 py-2">REG No</th>
