                            ...
                            <div class="p-3">
                                <table class="table-responsive w-full rounded">
									...
									while($users_details = mysqli_fetch_array($select_user)){
									 ...
									 ?><tr>
                                            <td class="border px-4 py-2"><?php echo $users_details['room_id'];?></td> 
                                           ...
                                           <td class="border px-4 py-2"><?php echo $students_n;?><?php if($students_n>1){echo "&nbsp;Students";}else{echo "&nbsp;Student";};?></td>
											...
											?><a href="Delete_classroom?BACK=<?php echo $users_details['room_id'];?>" class="bg-red-500 cursor-pointer rounded p-1 mx-1 text-white">
