                    ...
                    <div class="flex flex-1  flex-col md:flex-row lg:flex-row mx-2">
                        <div class="mb-2 border-solid border-gray-300 rounded border shadow-sm w-full">
                            <div class="bg-gray-200 px-2 py-3 border-solid border-gray-200 border-b">
                                <a href="Certifications?STATUS=<?php echo $STATUS;?>"><button class='bg-blue-500 hover:bg-blue-800 text-white font-bold py-2 px-4 rounded'>Back</button></a>  
                              <a href="Add_Modules_per_Certification?CERTIFICATE=<?php echo $CERTIFICATE;?>&STATUS=<?php echo $STATUS;?>"><button class='bg-yellow-500 hover:bg-blue-800 text-white font-bold py-2 px-4 rounded'>Add New Module Name</button></a>   
									 ...
									 <td class="border px-4 py-1"><?php echo $module_details['course_id'];?></td>
                                           ...
                                           <td class="border px-4 py-2"><?php echo $module_details['course_name'];?> </td>
                                            ...
                                            <td class="border px-4 py-2">
                                               ...
                                               <?php if($STATUS =="Active"){
												?> <a href="Update_Module?CERTIFICATE=<?php echo $module_details['course_certificate'];?>&CURRENT=<?php echo $STATUS;?>&STATUS=Inactive&ID=<?php echo $module_details['course_id'];?>" class="bg-teal-300 cursor-pointer rounded p-1 mx-1 text-white">
                                                       <i class="fas fa-lock text-red-500 mx-2"></i>  </a><?php
											}else{
											?> <a href="Update_Module?CERTIFICATE=<?php echo $module_details['course_certificate'];?>&CURRENT=<?php echo $STATUS;?>&STATUS=Active&ID=<?php echo $module_details['course_id'];?>" class="bg-teal-300 cursor-pointer rounded p-1 mx-1 text-white">
                                                       <i class="fas fa-unlock text-green-500 mx-2"></i></a><?php	
											}?>
                                             <a href="Update_Module_per_certification?CERTIFICATE=<?php echo $module_details['course_certificate'];?>&CURRENT=<?php echo $STATUS;?>&STATUS=Active&ID=<?php echo $module_details['course_id'];?>" class="bg-teal-300 cursor-pointer rounded p-1 mx-1 text-white">
                                                       <i class="fas fa-pencil-alt text-green-500 mx-1"></i></a>
                                                       <a href="Delete_Module?CERTIFICATE=<?php echo $module_details['course_certificate'];?>&CURRENT=<?php echo $STATUS;?>&STATUS=Active&ID=<?php echo $module_details['course_id'];?>" class="bg-red-300 cursor-pointer rounded p-1 mx-1 text-white">
                                                       <i class="fas fa-trash text-red-500 mx-1"></i></a>
                                            </td>
                                        </tr><?php	
