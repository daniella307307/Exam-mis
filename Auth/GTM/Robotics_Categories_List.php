            ...
            <main class="bg-white-500 flex-1 p-3 overflow-hidden">
                ...
                <div class="flex flex-col">
                   ...
                   <a href="Robotics_Categories_List?STATUS=Inactive"><button class='bg-red-500 hover:bg-yellow-800 text-white font-bold py-2 px-4 rounded'>Inactive</button></a>  
                    <a href="Add_Robotics_Categories_List"><button class='bg-green-500 hover:bg-yellow-800 text-white font-bold py-2 px-4 rounded'> <i class="fas fa-plus text-white mx-2"></i>Add New</button></a>  
                                ...
                                <table class="table-responsive w-full rounded">
									...
									?><tr>
                                            ...
                                            <td class="border px-4 py-2">
                                              <a href="Update_Categories?STATUS=Active&ID=<?php echo $Category_details['category_id'];?>" class="bg-teal-300 cursor-pointer rounded p-1 mx-1 text-white">
                                                       <i class="fas fa-pen text-green-500 mx-2"></i></a>
                                               
                                               <?php if($Category_details['category_status']=="Active"){
												?> <a href="#" class="bg-teal-300 cursor-pointer rounded p-1 mx-1 text-white">
                                                       <i class="fas fa-lock text-red-500 mx-2"></i>  </a><?php
											}else{
											?><a href="Delete_Categories?STATUS=Inactive&ID=<?php echo $Category_details['category_id'];?>" class="bg-teal-300 cursor-pointer rounded p-1 mx-1 text-white">
                                                       <i class="fas fa-trash text-red-500 mx-2"></i>  </a><?php	
											}?>
