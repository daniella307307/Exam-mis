            ...
            <div class="flex flex-1 flex-col md:flex-row lg:flex-row mx-2">
                <div class="mb-2 border-solid border-gray-300 rounded border shadow-sm w-full">
                    <div class="bg-gray-200 px-2 py-3 border-solid border-gray-200 border-b">
                        ...
                        <a href="Add_Robotics_Materials?STATUS=Inactive"><button class='bg-green-500 hover:bg-yellow-800 text-white font-bold py-2 px-4 rounded'> <i class="fas fa-plus text-white mx-2"></i>Add New</button></a>  
                    </div>
                            ...
                            <tbody id="tableBody">
                                ...
                                <tr class="searchable">
                                  ...
                                  <td class="border px-4 py-2"><?php echo $country_details['category_name'];?></td>
                                    ...
                                    <td class="border px-4 py-2">
                                        <a href="Update_Material_List?CURRENT=<?php echo $STATUS;?>&STATUS=Active&ID=<?php echo $country_details['equipments_id'];?>" class="bg-teal-300 cursor-pointer rounded p-1 mx-1 text-white">
                                        ...
                                        <?php if($STATUS == "Active"){
                                            ...
                                            ?><a href="Delete_Material_List?CURRENT=<?php echo $STATUS;?>&STATUS=Inactive&ID=<?php echo $country_details['equipments_id'];?>" class="bg-teal-300 cursor-pointer rounded p-1 mx-1 text-white">
