        ...
        <div class="flex flex-1">
            ...
            <main class="bg-white-500 flex-1 p-3 overflow-hidden">
                ...
                <div class="flex flex-col">
                    ...
                    <div class="flex flex-1  flex-col md:flex-row lg:flex-row mx-2">
                        <div class="mb-2 border-solid border-gray-300 rounded border shadow-sm w-full">
                            <div class="bg-gray-200 px-2 py-3 border-solid border-gray-200 border-b flex flex-wrap items-center gap-2">
                               <span class="mr-2">Countries</span>
                   ...
                   <a href="Add_new_country" class="ml-auto"><button class='bg-blue-600 hover:bg-blue-800 text-white font-bold py-2 px-4 rounded'>+ Add New Country</button></a>
							</div>
                            <div class="p-3">
                                <table class="table-responsive w-full rounded">
                                    <thead>
                                      <tr>
                                        ...
                                        <th class="border w-1/8 px-4 py-2">Country Name</th>
										 <th class="border w-1/8 px-4 py-2">Currency Name</th>
										  <th class="border w-1/8 px-4 py-2">Currency code</th>
                                        <th class="border w-1/10 px-4 py-2">Local to USD</th>
									...
									?><tr>
                                            ...
                                            <td class="border px-4 py-2"><?php echo $country_details['Country_currency'];?></td> 
                                            <td class="border px-4 py-2"><?php echo $country_details['Country_currency_code'];?></td> 
											<td class="border px-4 py-2"><?php echo $country_details['currency_usd'];?></td> 
                                            ...
                                            <td class="border px-4 py-2">
                                               ...
                                               <?php if($STATUS =="Active"){
												?> <a href="Update_Countries?CURRENT=<?php echo $STATUS;?>&STATUS=Inactive&ID=<?php echo $country_details['id'];?>" class="bg-teal-300 cursor-pointer rounded p-1 mx-1 text-white">
                                                       <i class="fas fa-lock text-red-500 mx-2"></i>  </a>
													   
													<a href="Update_Countries_details?CURRENT=<?php echo $STATUS;?>&STATUS=Active&ID=<?php echo $country_details['id'];?>" class="bg-teal-300 cursor-pointer rounded p-1 mx-1 text-white">
