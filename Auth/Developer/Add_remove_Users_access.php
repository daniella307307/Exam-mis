 ...
 $ID =$_GET['ID'];
 $select_user = mysqli_fetch_array(mysqli_query($conn,"SELECT * FROM users WHERE user_id='$ID'"));
 $firstname1  = $select_user['firstname'];
 $lastname1  =$select_user['lastname']; 
 $email_address1 = $select_user['email_address'];
                    ...
                    <div class="flex flex-1  flex-col md:flex-row lg:flex-row mx-2">
                        <div class="mb-2 border-solid border-gray-300 rounded border shadow-sm w-full">
                            <div class="bg-gray-200 px-2 py-3 border-solid border-gray-200 border-b">
							      <center><big><strong>User Access Levels &nbsp;&nbsp;<?php if($user_roles>=$setting_maxrole_no){
								...
								?></strong></big> </center>
                                <big><strong>First Name:<?php echo $firstname1;?></strong></big><br> 
 								<big><strong>Last Name:<?php echo $lastname1;?></strong></big> <br>
								<big><strong>Email:<?php echo $email_address1;?></strong></big><br> 
...
LEFT JOIN users ON active_user_permission.Active_user_ref = users.user_id WHERE  Active_user_ref =$ID");
							 ...
							 ?><tr>
                                            <td class="border px-4 py-2"><?php echo $users_roles_detail['active_permission_id'];?></td>
...
?>  <a href="#"><button class='bg-red-500 hover:bg-yellow-800 text-white font-bold py-2 px-4 rounded'>Inactive</button></a><?php	  
 ...
 <?php
  if($users_roles_detail['permission_status']=="Active"){
														...
														?><a href="Deactivate_roles?USER=<?php echo $ID;?>&&ID=<?php echo $users_roles_detail['active_permission_id'];?>" class="bg-green-500 cursor-pointer rounded p-1 mx-1 text-white">
