	  ...
	  ?>
	   ...
	   <div class="">
                   ...
                   <label class="block text-sm text-gray-600" for="cus_email">Amount to pay</label>
                    <input class="w-full px-5 py-1 text-gray-700 bg-gray-200 rounded" id="cus_name" name="Amount" value ="<?php echo  $details_invoice['local'];?>" type="text"   required  placeholder="First Name" aria-label="Name" readonly>
...
LEFT JOIN countries ON banks.bank_country = countries.id WHERE sleep_school='$school_ref'");
