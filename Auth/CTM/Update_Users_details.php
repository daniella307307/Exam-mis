    ...
    <div class="w-full max-w-lg">
	 ...
	 <div class="">
				...
				<div class="">
				   ...
				   <input class="w-full px-5 py-1 text-gray-700 bg-gray-200 rounded" id="cus_name"  name="firstname" value ="<?php echo $details_user['firstname'];?>" type="text" required="" placeholder="First Name" aria-label="Name" readonly>
                </div>
				<div class=""> 
                   <label class="block text-sm text-gray-600" for="cus_email">Last Name</label>
                    <input class="w-full px-5 py-1 text-gray-700 bg-gray-200 rounded" id="cus_name"  name="lastname" value ="<?php echo $details_user['lastname'];?>" type="text" required="" placeholder="Last Name" aria-label="Name" readonly>
                </div>
				<div class="mt-2">
					 ...
					 <div class="w-full md:w-1/3 px-3 mb-6 md:mb-0">
                        ...
                        <div class="relative">
                            <select name="access_level"
                                ...
                                id="grid-state">
                               <?php
								$select_role= mysqli_query($conn,"SELECT * FROM user_permission WHERE  per_status='Active' AND permissio_value <=1");
					 ...
					 <div class="w-full md:w-1/3 px-3 mb-6 md:mb-0">
                        ...
                        <div class="relative">
                            <select name="school_ref"
								...
								<?php
								$select_chool= mysqli_query($conn,"SELECT * FROM schools WHERE country_ref=$user_country");
