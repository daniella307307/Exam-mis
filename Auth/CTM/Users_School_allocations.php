...
if(isset($_GET['STATUS']) && isset($_GET['USER'])){
    ...
    $user_query = mysqli_prepare($conn, "SELECT * FROM users
        ...
        WHERE user_id = ?");
    mysqli_stmt_bind_param($user_query, "i", $USER);
                    ...
                    <?php if($STATUS == "Active"): ?>
                        <div>
                            <a href="Add_new_allocation?USER=<?php echo $USER; ?>">
                                <button class='bg-green-600 hover:bg-green-700 text-white font-bold py-3 px-6 rounded-lg transition duration-200 shadow-md flex items-center'>
                        ...
                        <table class="min-w-full table-auto">
                            <thead>
                                <tr class="bg-gray-50 border-b-2 border-gray-200">
                                    ...
                                    <th class="px-6 py-4 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider w-64">Actions</th>
                                </tr>
                            </thead>
                                    ...
                                    <td class="px-6 py-4">
                                        <div class="flex flex-col space-y-2">
                                            ...
                                            <div class="flex space-x-2">
                                                <!-- Edit Button -->
                                                <a href="Update_allocation?ID=<?php echo $country_details['allocation_id']; ?>&USER=<?php echo $USER; ?>" 
                                                   class="flex-1 bg-blue-500 hover:bg-blue-600 cursor-pointer rounded-lg py-2 px-3 text-white text-sm font-medium transition duration-200 shadow-sm flex items-center justify-center"
                                            ...
                                            <div class="flex space-x-2">
                                                <!-- Students Button -->
                                                <a href="Students_per_school?SCHOOL=<?php echo $country_details['school_id']; ?>" 
                                                   class="flex-1 bg-green-500 hover:bg-green-600 cursor-pointer rounded-lg py-2 px-3 text-white text-sm font-medium transition duration-200 shadow-sm flex items-center justify-center"
                                                   title="View Students">
                                                ...
                                                <!-- Delete Button -->
                                                <a href="Delete_allocation?ID=<?php echo $country_details['allocation_id']; ?>&USER=<?php echo $USER; ?>" 
                                                   class="flex-1 bg-red-500 hover:bg-red-600 cursor-pointer rounded-lg py-2 px-3 text-white text-sm font-medium transition duration-200 shadow-sm flex items-center justify-center"
                                                   title="Delete Allocation"
                                                   onclick="return confirm('Are you sure you want to delete this allocation? This action cannot be undone.')">
                                            ...
                                            <div class="flex space-x-1 pt-1">
                                                <!-- Quick Edit -->
                                                <a href="Quick_edit_days?ID=<?php echo $country_details['allocation_id']; ?>&USER=<?php echo $USER; ?>" 
                                                   class="flex-1 bg-purple-400 hover:bg-purple-500 cursor-pointer rounded py-1 px-2 text-white text-xs transition duration-200 flex items-center justify-center"
                                                   title="Quick Edit Days">
                                                ...
                                                <!-- Report -->
												<!--
                                                <a href="Allocation_report?ID=<?php echo $country_details['allocation_id']; ?>" 
                                                   class="flex-1 bg-orange-400 hover:bg-orange-500 cursor-pointer rounded py-1 px-2 text-white text-xs transition duration-200 flex items-center justify-center"
