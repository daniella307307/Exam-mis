            ...
            <form  action ="" method= "POST" class="max-w-xl m-4 p-10 bg-white rounded shadow-xl">
				...
				<div class=""> 
                   <label class="block text-sm text-gray-600" for="cus_email">Country</label>
                    <input class="w-full px-5 py-1 text-gray-700 bg-gray-200 rounded" id="currency_usd"  name="Country" value ="<?php echo $Country_name;?>" type="text" readonly  placeholder="usd Value" aria-label="Name">
			   ...
			   <div class=""> 
                   <label class="block text-sm text-gray-600" for="cus_email">Region</label>
                    <input class="w-full px-5 py-1 text-gray-700 bg-gray-200 rounded" id="currency_usd"  name="Region" value ="<?php echo $region_name;?>" type="text"  readonly  placeholder="usd Value" aria-label="Name">
