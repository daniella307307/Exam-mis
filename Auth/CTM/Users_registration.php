                ...
                <div class='flex flex-col'>
                    ...
                    <div class='flex flex-1  flex-col md:flex-row lg:flex-row mx-2'>
                        <div class="mb-2 mx-2 border-solid border-gray-300  rounded border shadow-sm w-full md:w-1/2 lg:w-1/2">
                            ...
                            <div class="p-3">
                                <a href="Add_new_user"><button   class="modal-trigger bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
                                    Register New User
                                </button></a>
                            </div>
...
<div id='toppedModal' class="modal-wrapper">
    ...
    <div class="modal">
        <div class="modal-content shadow-lg p-5">
            ...
            <!-- Modal content -->
              <form id='form_id' action="invite_user" enctype="multipart/form-data"  method="POST" class="w-full">
...
<div id='centeredFormModal' class="modal-wrapper">
    ...
    <div class="modal modal-centered">
        <div class="modal-content shadow-lg p-5">
            ...
            <!-- Modal content -->
            <form id='form_id' action="Add_new_user"  method="POST" enctype="multipart/form-data"class="w-full">
...
<div class="flex flex-wrap -mx-3 mb-6">
					 ...
					 <div class="w-full md:w-1/3 px-3 mb-6 md:mb-0">
                        ...
                        <div class="relative">
                            <select name="school_ref"
								...
								<?php
								$select_chool= mysqli_query($conn,"SELECT * FROM schools where school_id='$school_ref'");
                ...
                <div class="mt-5">
                    <button name="Addnew" type ="submit" class='bg-green-500 hover:bg-green-800 text-white font-bold py-2 px-4 rounded'> Submit </button>
                    <span class='close-modal cursor-pointer bg-red-200 hover:bg-red-500 text-red-900 font-bold py-2 px-4 rounded'>
                        Close
                    </span>
                </div>
