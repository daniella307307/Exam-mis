...
LEFT JOIN certifications ON students_promotion.promotion_certification = certifications.certification_id  WHERE promotion_id =$ID"));
 ?>
   ...
   <div style="position:center" class="mb-2 border-solid border-green-300 rounded border shadow-sm w-full">
                          ...
                          <big><strong><?php echo $details_user['promotion_name']; ?> </strong></big> Promotion  Details  &nbsp; &nbsp; &nbsp; <a href="Promotions?STATUS=Active"><button class='bg-green-500 hover:bg-blue-800 text-white font-bold py-2 px-4 rounded'><i class="fas fa-users angle-right float-left"></i> &nbsp; Back</button></a>  
  ...
  <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Amount To pay USD :&nbsp;<strong><?php echo  $details_user['promotion_pay_usd']; ?></strong></p>
  <p>&nbsp;&nbsp;Amount To pay Local :&nbsp;<strong><?php echo  $details_user['promotion_pay_local']; ?></strong></p>
