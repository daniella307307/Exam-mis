...
//////////////////////END OF UPLOARD PICTURE///////
				  ...
				  <div class="">
                    ...
                    <div class="mt-2">
                        ...
                        <input class="w-full px-5 py-4 text-gray-700 bg-blue-200 rounded" id="phone_number" name="phone_number" value="<?php echo $details_user['phone_number']; ?>" type="eadonly"   placeholder="Phone No" required>
                    </div>
                    
                    <div class="mt-2">
                        <label class="block text-sm text-gray-600" for="email_address">Email</label>
                        <input class="w-full px-5 py-4 text-gray-700 bg-blue-200 rounded" id="email_address" name="email_address" value="<?php echo $details_user['email_address']; ?>" type="email" required>
                    </div>
