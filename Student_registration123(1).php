...
<body>
  <div class="registration-container">
    <div class="registration-header">
      <h2><i class="fas fa-user-plus me-2"></i>Register Your child as New Student</h2>
    </div>
      ...
      <div class="form-section active" id="step1">
        <div class="mb-4">
          ...
          <select name="user_region" id="REGION" required class="form-select">
            ...
            <?php  
            $select_region = mysqli_query($conn, "SELECT * FROM regions_table WHERE region_name ='Eastern Africa' AND region_status = 'Active'");
